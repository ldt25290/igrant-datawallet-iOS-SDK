...
class AboutViewController: AriesBaseViewController {
    ...
    @IBAction func tappedOnAriesProtocolsButton(_ sender: Any) {
        if let webviewVC = UIStoryboard(name:"igrant-datawallet", bundle:UIApplicationUtils.shared.getResourcesBundle()).instantiateViewController( withIdentifier: "WebViewVC") as? WebViewViewController {
